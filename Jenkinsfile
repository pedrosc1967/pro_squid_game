    ...
    stages {
            stage ('Checkout') {
                steps {
                    ...
                    sh "git clone https://github.com/pedrosc1967/pro_squid_game.git"
                    sh "cp /Users/aplanetbit/StudioProjects/pro_squid_game/android/key.properties /Users/aplanetbit/.jenkins/workspace/'Squid Game Pro'/pro_squid_game/android/key.properties"
            ...
            stage ('Flutter Build APK') {
                steps {
                    ...
                    sh "cp /Users/aplanetbit/.jenkins/workspace/'Squid Game Pro'/build/app/outputs/flutter-apk/app-release.apk /Users/aplanetbit/Downloads/app-release.apk"
            ...
            stage ('Make iOS IPA ') {
                 steps {
                      dir('ios'){
                               ...
                               sh "cp /Users/aplanetbit/.jenkins/workspace/'Squid Game Pro'/ios/Runner.ipa /Users/aplanetbit/Downloads/Runner.ipa"
                      }
                 }
            }
            stage ('Notify Result') {
