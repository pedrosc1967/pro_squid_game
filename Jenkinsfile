    ...
    stages {
            stage ('Checkout') {
                steps {
                    ...
                    sh "cp /Users/aplanetbit/StudioProjects/pro_squid_game/android/key.properties /Users/aplanetbit/.jenkins/workspace/'Dictionary of Insurance Pro'/pro_squid_game/android/key.properties"
